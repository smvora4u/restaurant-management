...
export default function StaffWaitlistPage() {
  ...
  const { data: waitlistData, loading, refetch } = useQuery(GET_WAITLIST, { skip: !restaurantId });
  useWaitlistSubscription({ restaurantId: restaurantId || '', onWaitlistUpdated: refetch });
          ...
          {loading ? (
            ...
            <CardContent>
              <Typography variant="body1" color="text.secondary" align="center">
                No one on the waitlist. Click "Add to Waitlist" to add customers, or they can join via the QR code at the entrance.
              </Typography>
            </CardContent>
          ) : (
            <TableContainer>
